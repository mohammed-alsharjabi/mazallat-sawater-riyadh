...
class StoreLeadRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'preferred_contact' => ['required', Rule::in(['phone', 'whatsapp'])],
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge(['phone' => $phone, 'type' => $this->input('type', 'quote'), 'preferred_contact' => $this->input('preferred_contact', 'phone')]);
    }
}
