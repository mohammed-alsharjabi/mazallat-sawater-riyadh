...
class ServiceImageImportService
{
    ...
    private function defaultContext(Service $service): string
    {
        return match ($service->name) {
            'مظلات PVC' => 'مظلة PVC بغطاء قماشي وهيكل معدني',
            'مظلات الشد الإنشائي' => 'مظلة شد إنشائي بقماش مشدود',
            'الهناجر' => 'هيكل هنجر حديد أثناء التنفيذ',
            'شبوك وأسوار' => 'سياج معدني وشبك حماية خارجي',
            'الساندوتش بنل' => 'غرفة خارجية مصنوعة من ألواح ساندوتش بنل',
            'جلسات زجاجية' => 'جلسة خارجية بواجهات زجاجية',
            'البرجولات' => 'برجولة خارجية بهيكل معدني',
            'بيوت الشعر' => 'بيت شعر خارجي بقماش عازل وواجهات مجهزة',
            'الخيام' => 'خيمة خارجية بتغطية قماشية',
            'الشترات' => 'شتر رول لحماية واجهة خارجية',
            'النوافذ' => 'نافذة خارجية مزودة بشتر رول',
            'الأبواب الكهربائية' => 'باب رول كهربائي لمدخل مبنى',
